...
// Global vectors for Union-Find structure
vector<int> parent;
vector<int> rank_;
...
// Union by rank, returns false if u and v are already connected (cycle)
...
// Finds the redundant connection in edges
vector<int> findRedundantConnection(vector<vector<int>>& edges) {
    ...
    return {};  // no redundant edge found (should not happen)
}
